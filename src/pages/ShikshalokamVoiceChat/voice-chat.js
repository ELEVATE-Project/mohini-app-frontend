...
const ShikshalokamVoiceBasedChat = ({ type = "", variant = "" }) => {
  ...
  const isSpecialFlow = useMemo(() => {
    ...
    return [sessionFlowName.GuestDiscussion, sessionFlowName.ListeningActivity, sessionFlowName.GuestMiStory, sessionFlowName.ParentPerceptionSurvey, sessionFlowName.SanjhiSikhiyaStoryBot, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow)
  }, [storageFlow])
    ...
    <>
            ...
            {endStoryMutation.isPending && (
              <div className="div69 text-center">
                <h2 className="form-label label1 font-bold text-lg sm:text-2xl text-center">
                  {storageFlow && [sessionFlowName.ListeningActivity].includes(storageFlow) ? t("feedbackLoaderHeading") : storageFlow && [sessionFlowName.GuestDiscussion, sessionFlowName.LoginDiscussion, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow) ? t("reportLoaderHeading") : storageFlow && [sessionFlowName.Youth_21_25, sessionFlowName.Youth_12_20].includes(storageFlow) ? t("youth_storyGuestLoaderHeading") : storageFlow && [sessionFlowName.GuestMiStory, sessionFlowName.SanjhiSikhiyaStoryBot].includes(storageFlow) ? t("storyGuestLoaderHeading") : t("storyLoaderHeading")}
                </h2>
                <label className="form-label label1 text-center">{storageFlow && [sessionFlowName.GuestDiscussion, sessionFlowName.ListeningActivity, sessionFlowName.LoginDiscussion, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow) ? t("reportLoader") : storageFlow && [sessionFlowName.Youth_21_25, sessionFlowName.Youth_12_20].includes(storageFlow) ? t("youth_storyLoader") : t("storyLoader")}</label>
              </div>
            )}
          </div>
        </div>
      ...
      <div className={`${accessToken ? "div72" : isOpen ? "div71" : ""}`}>
        ...
        <div className={`${accessToken ? "div33-a" : "div33"} div9`}>
            ...
            <>
              {storageFlow &&
                (() => {
                  ...
                  const homePageHeading = [sessionFlowName.GuestDiscussion, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow) ? "homepageHeadingDiscussion" : "homepageHeading"
                  return (
                    <>
                      <div className="div10">
                        <h3 className="h3-1">
          ...
          {isStreamingComplete && showFileInput && !showHomepage && !endStoryMutation.isPending && !isLoading && !isPdfDownloading && storyData?.id !== "" && !([sessionFlowName.GuestMiStory, sessionFlowName.SanjhiSikhiyaStoryBot].includes(storageFlow) && accessToken) && (
            <>
              ...
              {![sessionFlowName.ParentPerceptionSurvey].includes(storageFlow) && (
                <div className="div19">
                  <ChatMessage
                    botNameToDisplay={botNameToDisplay}
                    userType="bot"
                    message={storageFlow && [sessionFlowName.GuestDiscussion, sessionFlowName.LoginDiscussion, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow) ? t("reportText") : storageFlow && [sessionFlowName.ListeningActivity].includes(storageFlow) ? t("reportFeedbackText") : storageFlow && [sessionFlowName.Youth_21_25, sessionFlowName.Youth_12_20].includes(storageFlow) ? t("youth_storyText") : t("storyText")}
                    isTalking={false}
                    handleOnStopSpeaking={() => handleOnStopSpeaking()}
                    handleOnSpeaking={(message, updatedAt, staticMessage) => {
                      const message_to_use = storageFlow && [sessionFlowName.GuestDiscussion, sessionFlowName.LoginDiscussion, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow) ? t("reportText") : storageFlow && [sessionFlowName.ListeningActivity].includes(storageFlow) ? t("reportFeedbackText") : storageFlow && [sessionFlowName.Youth_21_25, sessionFlowName.Youth_12_20].includes(storageFlow) ? t("youth_storyText") : t("storyText")
                      ...
                      >
                        <div className="download-story-div">
                          ...
                          <span className="div16" ref={endPageToScrollRef}>
                            {storageFlow && [sessionFlowName.GuestDiscussion, sessionFlowName.ListeningActivity, sessionFlowName.LoginDiscussion, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow) ? t("downloadReportText") : storageFlow && [sessionFlowName.Youth_21_25, sessionFlowName.Youth_12_20].includes(storageFlow) ? t("youth_downloadStoryText") : t("downloadStoryText")}
                          </span>
                        </div>
                      </button>
                  ...
                  <div className="div20">
                    <button className="clickable-button" onClick={openModal} disabled={isLoading || isPdfDownloading}>
                      <div className="download-story-div">
                        ...
                        <span className="div16" ref={endPageToScrollRef}>
                          {storageFlow && [sessionFlowName.GuestDiscussion, sessionFlowName.ListeningActivity, sessionFlowName.LoginDiscussion, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow) ? t("editReportText") : storageFlow && [sessionFlowName.Youth_21_25, sessionFlowName.Youth_12_20].includes(storageFlow) ? t("youth_editReportText") : t("editStoryText")}
                        </span>
                      </div>
                    </button>
                  </div>
              ...
              <div className="div20">
                ...
                >
                  <div className="download-story-div">
                    ...
                    <span className="div16" ref={endPageToScrollRef}>
                      {storageFlow && [sessionFlowName.GuestDiscussion, sessionFlowName.ListeningActivity, sessionFlowName.LoginDiscussion, sessionFlowName.SanjhiSikhiyaDiscussionBot].includes(storageFlow) ? t("reDownloadReportText") : t("reDownloadStoryText")}
                    </span>
                  </div>
                </button>
