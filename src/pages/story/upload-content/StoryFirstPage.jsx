        ...
        (props.currentState === 'Nagaland')?
            <div className="story-company-div-fmt1 no-page-break">
                <div className="story-logo-div">
                    ...
                    <img src="/images/grit_logo_pdf.png" className="story-logo3-fmt1" alt="pdf_bg1"></img>
                </div>
            </div>
            :
                ...
                >
                    {
                        ...
                        <>
                            <img src='/images/grit_logo_pdf.png' className="story-company-logo1" alt="company_logo" />
