...
export const env = {
  ...
  // Retry Configuration
  WEBSOCKET_RETRY_NUM: () => Number.parseInt(getEnv("REACT_APP_WEBSOCKET_RETRY_NUM", "2"), 10),
  S3_UPLOAD_RETRY_NUM: () => Number.parseInt(getEnv("REACT_APP_S3_UPLOAD_RETRY_NUM", "3"), 10),
  ...
  AUTH_KEY: () => getEnv("REACT_APP_AUTH_KEY", "accToken"),
